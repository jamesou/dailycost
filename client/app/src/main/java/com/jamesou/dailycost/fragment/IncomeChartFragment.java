...
public class IncomeChartFragment extends BaseChartFragment {
    ...
    protected void setAxisData(int year, int month) {
        ...
        if(isYear) {
            ...
            if(list.size()==0){
                ...
                barDataSet.setValueTextColor(Color.BLACK); // set value color
                barDataSet.setValueTextSize(8f);
                barDataSet.setColor(Color.GREEN); // bar color GREEN as income
    ...
    protected void setYAxis(int year, int month) {
        ...
        yAxis_left.setEnabled(false); // left yAxis
