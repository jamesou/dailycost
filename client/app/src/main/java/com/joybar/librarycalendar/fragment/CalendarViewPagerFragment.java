...
public class CalendarViewPagerFragment extends Fragment {
    ...
    private void initViewPager(View view){
        ...
        CalendarViewPagerAdapter myAdapter = new CalendarViewPagerAdapter(getChildFragmentManager(),isChoiceModelSingle);
    ...
    public void setCurrentItem(int year,int month){
        int yearcount = year - DateUtils.getYear();
        int monthcoutn = month -DateUtils.getMonth();
        int page = CalendarViewPagerAdapter.NUM_ITEMS_CURRENT+yearcount*12+monthcoutn;
